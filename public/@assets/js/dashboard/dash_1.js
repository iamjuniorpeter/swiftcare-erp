try {
  ...
  */
    ...
    var d_1options1 = {
     ...
     /*
      ===================================
      Enrollment & Verification | Options
      ===================================
  */
    ...
    var enverOptions = {
      ...
      series: [{
        name: 'Enrollees',
        data: JSON.parse(document.querySelector("#enverContainer").getAttribute('enrollees'))
      },{
        name: 'Unverified Enrollees',
        data: JSON.parse(document.querySelector("#enverContainer").getAttribute('unverifiedEnrollees'))
      }],
      xaxis: {
          categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
      },
  ...
  */
  ...
  /*
      ===================================
      Enrollments & Verification | Script
      ===================================
  */

    var enverChart = new ApexCharts(
        document.querySelector("#enverContainer"),
        enverOptions
    );
    enverChart.render();
