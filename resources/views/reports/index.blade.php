        ...
        <div class="container-fluid p-4">
            <div class="col-8 offset-2 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('reports.generate') }}" name="frmReports">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="report_type" class="form-label">Report Type</label>
                                    <select class="form-control form-select cmbSelect2" id="report_type" name="report_type" required>
                                        <option value="">-- Select Report Type --</option>
                                        <option value="stock_summary">Stock Summary</option>
                                        <option value="low_stock">Low Stock</option>
                                        <option value="stock_movement">Stock Movement</option>
                                        <option value="top_moving">Top Moving Items</option>
