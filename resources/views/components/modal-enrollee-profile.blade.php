...
<!-- Modal -->
<div class="modal fade" id="viewEnrolleeProfileModal{{ $params['modal_id'] }}" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enrollee Profile: {{ $params['modal_title'] }} </h5>
                        ...
                        <div class="card component-card_4">
                            <div class="card-body">
                                <div class="avatar avatar-xl text-center infobox-1">
                                    <img alt="" src="{{ $params['principal_records']['photograph'] ?? '' }}" class="img-responsive" style="width:200px; height:auto;" />
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row p-4">
                                            <div class="col-lg-3 text-center">
                                                <div class="card component-card_4">
                                                    <div class="card-body">
                                                        <div class="avatar avatar-xl text-center infobox-1">
                                                            <img alt="" src="{{ $dependant_data['photograph'] ?? '' }}" class="img-responsive" style="width:200px; height:auto;" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <h6 class="mt-2 font-weight-bold">ID Number: </h6>
