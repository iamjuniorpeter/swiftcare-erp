<x-layouts.master title="Update Customer" menutitle="Update Customer">
            ...
            <div class="col-10 offset-1 mt-3 mb-3">
                <div class="card mt-3">
                    <div class="card-header bg-primary">
                        <h3 class="text-white">Update Customer</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('customers.update', $customer->customer_id) }}" method="POST" name="frmSaveCustomer" id="frmSaveCustomer">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary btn-lg pull-right mt-3 btnSaveCustomer" id="btnSaveCustomer">Update Customer</button>
                            </div>
                        </form>
                    </div>
                </div>
